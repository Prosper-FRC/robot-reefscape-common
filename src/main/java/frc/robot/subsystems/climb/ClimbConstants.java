...
public class ClimbConstants {
  ...
  public static final Rotation2d kMinPosition = Rotation2d.fromDegrees(-360); // -1.586 and -1.907
  public static final Rotation2d kMaxPosition = Rotation2d.fromDegrees(360);

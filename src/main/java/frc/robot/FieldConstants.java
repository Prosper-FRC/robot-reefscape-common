...
public class FieldConstants {
    ...
    public static final Pose2d BR = new Pose2d(3.18, 3.64, Rotation2d.fromDegrees(120.0));

    public static final Pose2d CL = new Pose2d(3.52, 5.20, Rotation2d.fromDegrees(60.0));
    public static final Pose2d CR = new Pose2d(3.18, 5.38, Rotation2d.fromDegrees(60.0));

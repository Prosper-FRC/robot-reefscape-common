...
public class FieldConstants {
    ...
    public static final Pose2d kReefCenter = AllianceFlipUtil.apply(new Pose2d(4.48249, Constants.kFieldWidthMeters / 2.0, Rotation2d.fromDegrees(0.0)));
    ...
    public static final Pose2d B_IR = new Pose2d(1.24, 0.85, Rotation2d.fromRadians(-2.20));

...
public class FieldConstants {
    ...
    public static final Pose2d EL = new Pose2d(4.753, 2.657, Rotation2d.fromDegrees(-60.0));
    public static final Pose2d EM = new Pose2d(4.915, 2.805, Rotation2d.fromDegrees(-60.0));
    public static final Pose2d ER = new Pose2d(5.037, 2.843, Rotation2d.fromDegrees(-60.0));

    public static final Pose2d FL = new Pose2d(3.45, 3.096, Rotation2d.fromDegrees(-120.0));
    public static final Pose2d FM = new Pose2d(3.774, 2.955, Rotation2d.fromDegrees(-120.0));
    public static final Pose2d FR = new Pose2d(3.763, 2.9, Rotation2d.fromDegrees(-120.0));

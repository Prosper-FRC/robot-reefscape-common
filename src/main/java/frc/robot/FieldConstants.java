...
public class FieldConstants {
    ...
    public static final Pose2d AL = new Pose2d(3.48, 4.25, Rotation2d.k180deg);
    public static final Pose2d AM = new Pose2d(3.14, 4.02, Rotation2d.k180deg);
    public static final Pose2d AR = new Pose2d(3.45, 3.9, Rotation2d.k180deg);

    public static final Pose2d BL = new Pose2d(4.63, 5.13, Rotation2d.fromDegrees(120.0));
    public static final Pose2d BM = new Pose2d(3.85, 5.13, Rotation2d.fromDegrees(120.0));
    public static final Pose2d BR = new Pose2d(4.17, 4.94, Rotation2d.fromDegrees(120.0));
    ...
    public static final Pose2d FL = new Pose2d(3.55, 3.1, Rotation2d.fromDegrees(-120.0));
    public static final Pose2d FM = new Pose2d(3.86, 2.88, Rotation2d.fromDegrees(-120.0));
    public static final Pose2d FR = new Pose2d(3.75, 2.93, Rotation2d.fromDegrees(-120.0));

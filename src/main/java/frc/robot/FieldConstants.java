...
public class FieldConstants {
    ...
    public static final Pose2d AM = new Pose2d(0, 0, Rotation2d.k180deg);
    ...
    public static final Pose2d BM = new Pose2d(0, 0, Rotation2d.fromDegrees(120.0));
    ...
    public static final Pose2d CM = new Pose2d(0, 0, Rotation2d.fromDegrees(60.0));
    ...
    public static final Pose2d FM = new Pose2d(0, 0, Rotation2d.fromDegrees(-120.0));
    ...
    public static final Pose2d redIL = new Pose2d(16.07, 0.71, Rotation2d.fromRadians(2.20).plus(Rotation2d.k180deg));
    public static final Pose2d redIR = new Pose2d(16.33, 7.17, Rotation2d.fromRadians(-2.20).plus(Rotation2d.k180deg));

    public static final Pose2d blueIL = new Pose2d(1.59, 7.47, Rotation2d.fromRadians(2.20).plus(Rotation2d.k180deg).plus(Rotation2d.k180deg));
    public static final Pose2d blueIR = new Pose2d(1.24, 0.85, Rotation2d.fromRadians(-2.20).plus(Rotation2d.k180deg).plus(Rotation2d.k180deg));
}
